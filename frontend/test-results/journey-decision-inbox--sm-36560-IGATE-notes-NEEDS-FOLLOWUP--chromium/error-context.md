...
- Name: journey-decision-inbox.spec.ts >> @smoke J6-4 investigate path — state is DECLINED with [INVESTIGATE] notes (NEEDS_FOLLOWUP)
- Location: e2e/journey-decision-inbox.spec.ts:143:5
