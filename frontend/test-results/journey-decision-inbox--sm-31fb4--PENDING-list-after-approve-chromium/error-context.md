...
- Name: journey-decision-inbox.spec.ts >> @smoke J6-2 approve path — approval no longer in PENDING list after approve
- Location: e2e/journey-decision-inbox.spec.ts:83:5
