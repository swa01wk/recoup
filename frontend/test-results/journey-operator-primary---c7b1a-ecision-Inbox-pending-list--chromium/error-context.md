...
- Name: journey-operator-primary.spec.ts >> @smoke J2-3 promoted opportunity appears in Decision Inbox (pending list)
- Location: e2e/journey-operator-primary.spec.ts:80:5
