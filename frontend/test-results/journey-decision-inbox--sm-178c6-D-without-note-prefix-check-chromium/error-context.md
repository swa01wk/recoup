...
- Name: journey-decision-inbox.spec.ts >> @smoke J6-5 investigate does NOT set state to DECLINED without note prefix check
- Location: e2e/journey-decision-inbox.spec.ts:166:5
